...
#import "ViewController_Old.h"
#import "UIAlertView+Blocks.h"

@interface ViewController_Old ()
@property (nonatomic, strong) IBOutlet UIImageView *imageView;
@property (nonatomic, strong) IBOutlet UIButton *cameraButton;
@property (nonatomic, strong) IBOutlet UIButton *lunchButton;
@end

@implementation ViewController_Old
{
...
- (IBAction)_lunchIsReadyButtonPressed:(UIButton*)button
{
    [UIAlertView showWithTitle:nil message:@"Send Notification?" cancelButtonTitle:@"Cancel" otherButtonTitles:@[@"Send"] tapBlock:^(UIAlertView *alertView, NSInteger buttonIndex) {
        if (buttonIndex == 0)
        {
            [self _sendLunchIsReadyNotification];
        }
    }];
}


- (void)_sendLunchIsReadyNotification
{
...
- (IBAction)refresh:(id)sender
{
    ...
    PFQuery *query = [PFQuery queryWithClassName:@"Current_Menu"];
    query.limit = 1;
